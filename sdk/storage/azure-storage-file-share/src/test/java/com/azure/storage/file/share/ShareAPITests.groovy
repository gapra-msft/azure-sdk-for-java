...
//        def setPropertiesResponse = primaryShareClient.setPropertiesWithResponse(new ShareSetAccessTierOptions().setAccessTier(ShareAccessTier.HOT), null, null)
...
//        when:
//        primaryShareClient.setPropertiesWithResponse(new ShareSetAccessTierOptions().setAccessTier(ShareAccessTier.HOT), null, null)
//        then:
//        def e = thrown(ShareStorageException)
//        FileTestHelper.assertExceptionStatusCodeAndMessage(e, 404, ShareErrorCode.SHARE_NOT_FOUND)
//    }
